...
export const heroBadges = [
  ...
  { label: '1분~25분', detail: '길이 자유 조정' },
] as const;

export const heroStats = [
  { value: '2가지', label: '제작 모드', sub: '쇼츠 · 재구성' },
  { value: '25분', label: '최대 결과물 길이', sub: '1분 단위 조정' },
...
export const reconstructSteps = [
  ...
  },
  {
    ...
    detail:
      '1분에서 25분 사이로 정한 길이에 맞춰 장면을 고르고 붙여 한 편의 영상으로 만들어냅니다.',
  },
] as const;
...
export const faqs = [
  ...
  {
    q: '결과물 길이는 어떻게 정하나요?',
    a: '재구성 화면의 길이 조절기에서 1분부터 25분까지 1분 단위로 정할 수 있습니다. 정한 길이에 맞춰 어떤 장면을 남기고 어떤 장면을 접을지, 대본을 몇 자로 쓸지가 함께 결정됩니다.',
  },
  {
